...
export interface Page {
  ...
  layout: (CallToActionBlock | ContentBlock | MediaBlock | ArchiveBlock | FormBlock | ValuesBlock)[];
  meta?: {
    title?: string | null;
    /**
...
export interface ValuesBlock {
  ...
  items?:
    | {
        ...
        description: string;
        /**
         * Optional small illustration or icon (square works best).
         */
...
export interface JoinRequest {
  ...
  email: string;
  /**
   * Review status for this join request
   */
